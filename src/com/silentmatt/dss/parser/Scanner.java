...
public class Scanner {
	...
	static {
		...
		for (int i = 48; i <= 57; ++i) start.set(i, 19);
		...
		literals.put("global", new Integer(28));
	...
	Token NextToken() {
		...
		loop: for (;;) {
			switch (state) {
				...
				case 5:
					if (ch >= '0' && ch <= '3') {AddCh(); state = 24; break;}
				...
				case 12:
					if (ch >= '0' && ch <= '3') {AddCh(); state = 26; break;}
				...
				case 24:
					...
					else if (ch >= '0' && ch <= '7') {AddCh(); state = 25; break;}
					else if (ch == '"') {AddCh(); state = 18; break;}
					else if (ch == 92) {AddCh(); state = 5; break;}
					else {t.kind = noSym; break loop;}
				case 25:
				...
				case 26:
					...
					else if (ch >= '0' && ch <= '7') {AddCh(); state = 27; break;}
					else if (ch == 39) {AddCh(); state = 18; break;}
					else if (ch == 92) {AddCh(); state = 12; break;}
					else {t.kind = noSym; break loop;}
				case 27:
				...
				case 35:
					if (ch == '-' || ch >= 'G' && ch <= 'Z' || ch == '_' || ch >= 'g' && ch <= 'z' || ch >= 128 && ch <= 55295 || ch >= 57344 && ch <= 65533) {AddCh(); state = 1; break;}
					else if (ch >= '0' && ch <= '9' || ch >= 'A' && ch <= 'F' || ch >= 'a' && ch <= 'f') {AddCh(); state = 37; break;}
					else if (ch == 92) {AddCh(); state = 21; break;}
					else {t.kind = 1; t.val = new String(tval, 0, tlen); CheckLiteral(); return t;}
				case 36:
				...
				case 47:
					if (ch == 'd') {AddCh(); state = 48; break;}
					else {t.kind = noSym; break loop;}
				case 48:
					if (ch == 'i') {AddCh(); state = 49; break;}
					else {t.kind = noSym; break loop;}
				case 49:
					if (ch == 'a') {AddCh(); state = 50; break;}
					else {t.kind = noSym; break loop;}
				case 50:
				...
				case 60:
					if (ch == 'i') {AddCh(); state = 61; break;}
					else {t.kind = noSym; break loop;}
				case 61:
					if (ch == 'n') {AddCh(); state = 62; break;}
					else {t.kind = noSym; break loop;}
				case 62:
				...
				case 64:
					if (ch == 'o') {AddCh(); state = 65; break;}
					else {t.kind = noSym; break loop;}
				case 65:
					if (ch == 'n') {AddCh(); state = 66; break;}
					else {t.kind = noSym; break loop;}
				case 66:
					if (ch == 't') {AddCh(); state = 67; break;}
					else {t.kind = noSym; break loop;}
				case 67:
					if (ch == '-') {AddCh(); state = 68; break;}
					else {t.kind = noSym; break loop;}
				case 68:
					if (ch == 'f') {AddCh(); state = 69; break;}
					else {t.kind = noSym; break loop;}
				case 69:
					if (ch == 'a') {AddCh(); state = 70; break;}
					else {t.kind = noSym; break loop;}
				case 70:
					if (ch == 'c') {AddCh(); state = 71; break;}
					else {t.kind = noSym; break loop;}
				case 71:
				...
				case 73:
					if (ch == 'a') {AddCh(); state = 74; break;}
					else {t.kind = noSym; break loop;}
				case 74:
					if (ch == 'g') {AddCh(); state = 75; break;}
					else {t.kind = noSym; break loop;}
				case 75:
					if (ch == 'e') {AddCh(); state = 76; break;}
					else {t.kind = noSym; break loop;}
				case 76:
					{t.kind = 30; break loop;}
				case 77:
					if (ch == 'p') {AddCh(); state = 78; break;}
					else {t.kind = noSym; break loop;}
				case 78:
				...
				case 83:
					if (ch == 'l') {AddCh(); state = 84; break;}
					else {t.kind = noSym; break loop;}
				case 84:
					if (ch == 'u') {AddCh(); state = 85; break;}
					else {t.kind = noSym; break loop;}
				case 85:
					if (ch == 'd') {AddCh(); state = 86; break;}
					else {t.kind = noSym; break loop;}
				case 86:
					if (ch == 'e') {AddCh(); state = 87; break;}
					else {t.kind = noSym; break loop;}
				case 87:
					{t.kind = 32; break loop;}
				case 88:
					if (ch == 'a') {AddCh(); state = 89; break;}
					else {t.kind = noSym; break loop;}
				case 89:
					if (ch == 'r') {AddCh(); state = 90; break;}
					else {t.kind = noSym; break loop;}
				case 90:
					if (ch == 's') {AddCh(); state = 91; break;}
					else {t.kind = noSym; break loop;}
				case 91:
					if (ch == 'e') {AddCh(); state = 92; break;}
					else {t.kind = noSym; break loop;}
				case 92:
					if (ch == 't') {AddCh(); state = 93; break;}
					else {t.kind = noSym; break loop;}
				case 93:
				...
				case 95:
					if (ch == 'm') {AddCh(); state = 96; break;}
					else {t.kind = noSym; break loop;}
				case 96:
					if (ch == 'e') {AddCh(); state = 97; break;}
					else {t.kind = noSym; break loop;}
				case 97:
					if (ch == 's') {AddCh(); state = 98; break;}
					else {t.kind = noSym; break loop;}
				case 98:
					if (ch == 'p') {AddCh(); state = 99; break;}
					else {t.kind = noSym; break loop;}
				case 99:
					if (ch == 'a') {AddCh(); state = 100; break;}
					else {t.kind = noSym; break loop;}
				case 100:
					if (ch == 'c') {AddCh(); state = 101; break;}
					else {t.kind = noSym; break loop;}
				case 101:
				...
				case 111:
					if (ch == '=') {AddCh(); state = 112; break;}
					else {t.kind = noSym; break loop;}
				case 112:
					{t.kind = 46; break loop;}
				case 113:
					if (ch == '=') {AddCh(); state = 114; break;}
					else {t.kind = noSym; break loop;}
				case 114:
				...
				case 126:
					if (ch == 'a') {AddCh(); state = 127; break;}
					else {t.kind = noSym; break loop;}
				case 127:
					if (ch == 'n') {AddCh(); state = 128; break;}
					else {t.kind = noSym; break loop;}
				case 128:
					if (ch == 't') {AddCh(); state = 129; break;}
					else {t.kind = noSym; break loop;}
				case 129:
				...
				case 133:
					if (ch == 'm') {AddCh(); state = 46; break;}
					else if (ch == 'c') {AddCh(); state = 137; break;}
					else if (ch == 'd') {AddCh(); state = 58; break;}
					else if (ch == 'f') {AddCh(); state = 64; break;}
					else if (ch == 'p') {AddCh(); state = 73; break;}
					else if (ch == 'i') {AddCh(); state = 138; break;}
					else if (ch == 'n') {AddCh(); state = 94; break;}
					else {t.kind = 35; break loop;}
				case 134:
					if (ch == '=') {AddCh(); state = 110; break;}
				...
				case 136:
					if (ch == '-' || ch >= '0' && ch <= '9' || ch >= 'A' && ch <= 'Z' || ch == '_' || ch >= 'a' && ch <= 'z' || ch >= 128 && ch <= 55295 || ch >= 57344 && ch <= 65533) {AddCh(); state = 1; break;}
					else if (ch == 92) {AddCh(); state = 139; break;}
					else {t.kind = 1; t.val = new String(tval, 0, tlen); CheckLiteral(); return t;}
				case 137:
					if (ch == 'l') {AddCh(); state = 53; break;}
					else if (ch == 'h') {AddCh(); state = 88; break;}
					else {t.kind = noSym; break loop;}
				case 138:
					if (ch == 'm') {AddCh(); state = 77; break;}
					else if (ch == 'n') {AddCh(); state = 82; break;}
					else {t.kind = noSym; break loop;}
				case 139:
					if (ch >= '0' && ch <= '9' || ch >= 'A' && ch <= 'F' || ch >= 'a' && ch <= 'f') {AddCh(); state = 29; break;}
					else if (ch >= ' ' && ch <= '/' || ch >= ':' && ch <= '@' || ch >= 'G' && ch <= '`' || ch >= 'g' && ch <= '~' || ch >= 128 && ch <= 55295 || ch >= 57344 && ch <= 65533) {AddCh(); state = 1; break;}
