...
public class Scanner {
	...
	static {
		...
		literals.put("global", new Integer(31));
		literals.put("calc", new Integer(56));
	...
	Token NextToken() {
		...
		loop: for (;;) {
			switch (state) {
				...
				case 60:
					if (ch == 'f') {AddCh(); state = 61; break;}
					else {t.kind = noSym; break loop;}
				case 61:
					if (ch == 'i') {AddCh(); state = 62; break;}
					else {t.kind = noSym; break loop;}
				case 62:
					if (ch == 'n') {AddCh(); state = 63; break;}
					else {t.kind = noSym; break loop;}
				case 63:
					if (ch == 'e') {AddCh(); state = 64; break;}
					else {t.kind = noSym; break loop;}
				case 64:
				...
				case 69:
					if (ch == 'f') {AddCh(); state = 70; break;}
					else {t.kind = noSym; break loop;}
				case 70:
					if (ch == 'a') {AddCh(); state = 71; break;}
					else {t.kind = noSym; break loop;}
				case 71:
					if (ch == 'c') {AddCh(); state = 72; break;}
					else {t.kind = noSym; break loop;}
				case 72:
					if (ch == 'e') {AddCh(); state = 73; break;}
					else {t.kind = noSym; break loop;}
				case 73:
				...
				case 78:
					if (ch == 'p') {AddCh(); state = 79; break;}
					else {t.kind = noSym; break loop;}
				case 79:
					if (ch == 'o') {AddCh(); state = 80; break;}
					else {t.kind = noSym; break loop;}
				case 80:
					if (ch == 'r') {AddCh(); state = 81; break;}
					else {t.kind = noSym; break loop;}
				case 81:
				...
				case 84:
					if (ch == 'l') {AddCh(); state = 85; break;}
					else {t.kind = noSym; break loop;}
				case 85:
					if (ch == 'u') {AddCh(); state = 86; break;}
					else {t.kind = noSym; break loop;}
				case 86:
					if (ch == 'd') {AddCh(); state = 87; break;}
					else {t.kind = noSym; break loop;}
				case 87:
					if (ch == 'e') {AddCh(); state = 88; break;}
					else {t.kind = noSym; break loop;}
				case 88:
					{t.kind = 35; break loop;}
				case 89:
					if (ch == 'a') {AddCh(); state = 90; break;}
					else {t.kind = noSym; break loop;}
				case 90:
					if (ch == 'r') {AddCh(); state = 91; break;}
					else {t.kind = noSym; break loop;}
				case 91:
					if (ch == 's') {AddCh(); state = 92; break;}
					else {t.kind = noSym; break loop;}
				case 92:
					if (ch == 'e') {AddCh(); state = 93; break;}
					else {t.kind = noSym; break loop;}
				case 93:
				...
				case 95:
					if (ch == 'a') {AddCh(); state = 96; break;}
					else {t.kind = noSym; break loop;}
				case 96:
					if (ch == 'm') {AddCh(); state = 97; break;}
					else {t.kind = noSym; break loop;}
				case 97:
					if (ch == 'e') {AddCh(); state = 98; break;}
					else {t.kind = noSym; break loop;}
				case 98:
					if (ch == 's') {AddCh(); state = 99; break;}
					else {t.kind = noSym; break loop;}
				case 99:
					if (ch == 'p') {AddCh(); state = 100; break;}
					else {t.kind = noSym; break loop;}
				case 100:
					if (ch == 'a') {AddCh(); state = 101; break;}
					else {t.kind = noSym; break loop;}
				case 101:
					if (ch == 'c') {AddCh(); state = 102; break;}
					else {t.kind = noSym; break loop;}
				case 102:
				...
				case 133:
					...
					else if (ch == 'd') {AddCh(); state = 59; break;}
					else if (ch == 'f') {AddCh(); state = 65; break;}
					else if (ch == 'p') {AddCh(); state = 74; break;}
					else if (ch == 'i') {AddCh(); state = 138; break;}
					else if (ch == 'n') {AddCh(); state = 95; break;}
				...
				case 137:
					...
					else if (ch == 'h') {AddCh(); state = 89; break;}
					else {t.kind = noSym; break loop;}
				case 138:
					if (ch == 'm') {AddCh(); state = 78; break;}
					else if (ch == 'n') {AddCh(); state = 83; break;}
					else {t.kind = noSym; break loop;}
				case 139:
					if (ch >= '0' && ch <= '9' || ch >= 'A' && ch <= 'F' || ch >= 'a' && ch <= 'f') {AddCh(); state = 29; break;}
					else if (ch >= ' ' && ch <= '/' || ch >= ':' && ch <= '@' || ch >= 'G' && ch <= '`' || ch >= 'g' && ch <= '~' || ch >= 128 && ch <= 55295 || ch >= 57344 && ch <= 65533) {AddCh(); state = 1; break;}
