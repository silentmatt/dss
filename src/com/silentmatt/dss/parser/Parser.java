 ...
 *------------------------------------------------------------------------*/
	...
	void CSS3() {
		...
		while (StartOf(1)) {
			if (StartOf(2)) {
				rset = ruleset();
				CSSDoc.getRuleSets().add(rset); 
			} else {
				dir = directive();
				CSSDoc.getDirectives().add(dir); 
			}
			while (la.kind == 3 || la.kind == 5 || la.kind == 6) {
				if (la.kind == 5) {
					Get();
				...
				if (StartOf(5)) {
					while (StartOf(1)) {
						if (StartOf(3)) {
							...
							rset = ruleset();
							dirb.getRuleSets().add(rset); 
						} else {
							dr = directive();
							dirb.getDirectives().add(dr); 
						}
					}
				}
				Expect(23);
	...
	Term  term() {
		...
		if (la.kind == 4) {
			...
			if (StartOf(9)) {
				while (la.kind == 40 || la.kind == 42 || la.kind == 49) {
					if (la.kind == 49) {
						Get();
	...
	private static final boolean[][] set = {
		...
		{x,T,x,x, x,x,x,T, x,x,T,T, T,T,T,T, T,T,T,T, T,T,x,x, T,x,T,T, T,T,T,T, T,T,x,x, x,x,T,T, T,T,x,x, x,x,x,x, x,T,x,x, x,x,x,x, x},
		{x,T,x,x, x,x,x,T, x,x,T,T, T,T,T,T, T,T,T,T, T,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,T,T, T,T,x,x, x,x,x,x, x,T,x,x, x,x,x,x, x},
		{x,T,x,x, x,x,x,T, x,x,T,T, T,T,T,T, T,T,T,T, T,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x},
		{x,T,T,x, T,x,x,T, x,x,T,T, T,T,T,T, T,T,T,T, T,x,T,x, x,T,x,x, x,x,x,x, x,x,T,T, x,x,x,T, T,x,x,x, x,x,x,x, x,x,x,T, T,T,T,x, x},
		{x,T,x,x, x,x,x,T, x,x,T,T, T,T,T,T, T,T,T,T, T,T,x,T, T,x,T,T, T,T,T,T, T,T,x,x, x,x,T,T, T,T,x,x, x,x,x,x, x,T,x,x, x,x,x,x, x},
		{x,T,T,T, T,T,T,T, T,T,T,T, T,T,T,T, T,T,T,T, T,T,T,T, T,T,T,T, T,T,T,T, T,T,T,T, T,T,T,T, T,T,T,T, T,T,T,T, T,T,T,T, T,T,T,T, x},
		{x,T,T,T, x,T,T,T, T,x,T,T, T,T,T,T, T,T,T,T, T,T,T,T, T,T,T,T, T,T,T,T, T,T,T,T, T,T,T,T, T,T,T,T, T,T,T,T, T,T,T,T, T,T,T,T, x},
		{x,x,x,x, x,x,x,x, x,x,T,T, T,T,T,T, T,T,T,T, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x},
		{x,x,x,x, x,x,x,x, T,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, T,x,T,x, x,x,x,x, x,T,x,x, x,x,x,x, x},
		{x,T,T,x, T,x,x,T, T,T,T,T, T,T,T,T, T,T,T,T, T,T,T,T, T,T,T,T, T,T,T,T, T,T,T,T, x,x,T,T, T,T,T,x, x,x,x,x, x,T,T,T, T,T,T,x, x},
		{x,T,T,x, T,x,x,T, x,T,T,T, T,T,T,T, T,T,T,T, T,T,T,T, T,T,T,T, T,T,T,T, T,T,T,T, x,x,T,T, T,T,x,x, x,x,x,x, x,T,T,T, T,T,T,x, x},
		{x,T,x,x, x,x,x,T, x,x,T,T, T,T,T,T, T,T,T,T, T,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,T,x, x},
		{x,T,T,x, T,x,x,T, x,x,T,T, T,T,T,T, T,T,T,T, T,x,x,x, x,x,x,x, x,x,x,x, x,x,T,T, x,x,x,T, T,x,x,x, x,x,x,x, x,x,x,T, T,T,T,x, x},
		{x,T,x,x, x,x,x,T, x,x,T,T, T,T,T,T, T,T,T,T, T,x,x,x, x,x,x,x, x,x,x,x, x,x,x,T, T,T,T,T, T,T,x,x, x,x,x,x, x,T,x,x, x,x,x,x, x},
		{x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,T, T,T,x,x, x,x,x,x, x,T,x,x, x,x,x,x, x},
		{x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,T,T, T,T,T,T, x,x,x,x, x,x,x,x, x}
	...
	public static final String getErrorMessage(int n) {
		...
		switch (n) {
			...
			case 27: s = "\"@font-face\" expected"; break;
			case 28: s = "\"@page\" expected"; break;
			case 29: s = "\"@import\" expected"; break;
			case 30: s = "\"@include\" expected"; break;
			case 31: s = "\"@charset\" expected"; break;
			...
			case 50: s = "\"!important\" expected"; break;
			case 51: s = "\"/\" expected"; break;
			case 52: s = "\"U\\\\\" expected"; break;
			case 53: s = "\"-\" expected"; break;
			case 54: s = "\"%\" expected"; break;
			case 55: s = "??? expected"; break;
			case 56: s = "invalid directive"; break;
			case 57: s = "invalid directive"; break;
			case 58: s = "invalid URI"; break;
			case 59: s = "invalid medium"; break;
			case 60: s = "invalid identity"; break;
			case 61: s = "invalid term"; break;
			case 62: s = "invalid term"; break;
			case 63: s = "invalid namespaceDirective"; break;
			case 64: s = "invalid simpleselector"; break;
			case 65: s = "invalid attrib"; break;
			case 66: s = "invalid HexValue"; break;
